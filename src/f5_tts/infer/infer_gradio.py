...
with gr.Blocks(theme=custom_theme, css=custom_css) as app_tts:
    gr.HTML("""
        <div style="display: flex; align-items: center; margin-bottom: 1rem;">
         <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="800px" height="800px" viewBox="0 0 344.156 344.156" xml:space="preserve">
<g>
